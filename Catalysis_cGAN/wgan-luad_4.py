...
# def write_log2(writer_a,writer_d , d_loss, a_loss, i):
#     with writer.as_default():
#         # tf.summary.scalar('loss',{'Discriminator_loss': d_loss, 'Adversarial_loss': a_loss} , i)
#         #writer.flush()               
...
def train(models, data, params):
    ...
    writer = tf.summary.create_file_writer("./logs/log_cingulate_latent100_lr-5e-5")
