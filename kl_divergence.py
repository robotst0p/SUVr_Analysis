...
synth_suvr_x_1999 = pd.read_pickle("./gen_suvr_1999.pkl")
synth_suvr_x_29999 = pd.read_pickle("./gen_suvr_29999.pkl")

synth_control_x_1999 = pd.read_pickle("./gen_control_1999.pkl")
synth_control_x_29999 = pd.read_pickle("./gen_control_29999.pkl")

average_control_1999 = pd.read_pickle("./average_control_1999.pkl")
average_control_29999 = pd.read_pickle("./average_control_29999.pkl")

average_synth_1999 = pd.read_pickle("./average_synth_1999.pkl")
average_synth_29999 = pd.read_pickle("./average_synth_29999.pkl")

whole_suvr = pd.read_pickle("./whole_suvr_frame.pkl")
whole_control = pd.read_pickle("./whole_control_frame.pkl")
...
for i in range(0, 100):
    ...
    for i in range(0, len(axis_list)):
        sb.kdeplot(
            data=plot_frame_suvr.iloc[:, i].tolist(),
            ax=axis_list[i],
            label="synthetic AUD",
            color="orange",
        )
...
divergence_frame.to_pickle("./whole_divergence_frame.pkl")
